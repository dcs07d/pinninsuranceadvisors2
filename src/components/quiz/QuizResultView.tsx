...
import { Star, RefreshCcw, Loader2, ArrowRight } from 'lucide-react';
import { QuizResult } from '../../types/quiz';
import { notifyQuizCompletion } from '../../utils/notifications';
...
export default function QuizResultView({ 
  ...
  const recommendedPlan = medigapPercentage >= 60 ? 'medigap' : 'advantage';
